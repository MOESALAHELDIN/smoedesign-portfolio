    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="flex justify-between items-center p-6 bg-white">
        <div className="w-12 h-12">
          <svg viewBox="0 0 100 100" className="w-full h-full">
            ...
            <path d="M35,50 L65,50 L50,80 Z" fill="black" />
          </svg>
        </div>
      ...
      <main>
        ...
        <div className="relative">
          <Image
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Image%202025-05-19%20at%2016.26.24-wiNZlXctbJRuOlHhBmJEW7QqhXHwwg.jpeg"
            alt="Person with blue and pink lighting"
            width={1200}
            height={600}
        ...
        <div className="px-6 py-8 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center pt-4 border-t text-sm">
            <div className="text-gray-600 mb-4 sm:mb-0">
              ...
              <div className="text-gray-500">MON 19 MAY 2025</div>
            </div>
